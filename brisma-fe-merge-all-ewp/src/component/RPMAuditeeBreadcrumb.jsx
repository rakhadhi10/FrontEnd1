...
import { fetchAllKKPT, fetchKKPTDetails } from "../store/ducks/RPMAuditee/actions";
import { getKKPT, getKKPTMCS } from "../store/ducks/RPMAuditee/selectors";

const mapPathToLabel = {
  "": "BRISMA",
  "rpm": "RPM",
  "auditee/projects": "LIST RPM",
  "surat": "Surat",
  "riwayat-dokumen": "Dokumen",
}

const RPMAuditeeBreadcrumb = ({ mcs, kkpts, fetchAllKKPT, fetchKKPTDetails }) => {
...
export default connect(mapStateToProps, mapDispatchToProps)(RPMAuditeeBreadcrumb);

const getBreadcrumbItems = (path, mapPathToLabel) => {
  const splitPath = path.split("/")
  const addendumIndex = splitPath.indexOf("auditee")
  const part = "auditee/" + splitPath[addendumIndex + 1]
