...
export default function UkerTable({ data }) {
  return (
    <Table
      dataSource={data}
      pagination={false}
    ...
    >
      ...
      <Column
        ...
        title={() => <div className="text-center">Uker Existing</div>}
        dataIndex="existing"
        key="existing"
        render={(text, record) => (
      ...
      <Column
        className="text-center"
        title={() => <div className="text-center">Uker Audit</div>}
        dataIndex="audit"
        key="audit"
        render={(text, record) => (
