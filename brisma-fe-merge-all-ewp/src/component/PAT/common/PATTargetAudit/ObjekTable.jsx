...
export default function ObjekTable({ data }) {
  return (
    <Table
      dataSource={data}
      pagination={false}
    ...
    >
      ...
      <Column
        ...
        title={() => <div className="text-center">Objek Existing</div>}
        dataIndex="existing"
        key="existing"
        render={(text, record) => (
      ...
      <Column
        className="text-center"
        title={() => <div className="text-center">Objek Audit</div>}
        dataIndex="audit"
        key="audit"
        render={(text, record) => (
