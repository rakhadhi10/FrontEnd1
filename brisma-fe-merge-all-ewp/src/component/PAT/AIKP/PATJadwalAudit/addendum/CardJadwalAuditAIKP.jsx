...
import { deleteJadwalAudit, openEditModal } from "../../../../../store/ducks/AddendumPATAIKPJadwalAudit/actions";
import CardJadwalAudit from "../../../common/PATJadwalAudit/CardJadwalAudit";

const CardJadwalAuditAIKP = (props) => {
...
export default connect(mapStateToProps, mapDispatchToProps)(CardJadwalAuditAIKP)
