        ...
        <div className="flex flex-col gap-4">
          <div>
            ...
            <Form.Item name="nama_kegiatan_audit" className="m-0 w-10/12">
              <Input placeholder="AIWJakarta2_Special_KCPAmpera_Feb_2013" />
            </Form.Item>
          </div>
          <div hidden={selected_tipe_audit_code !== "REG"}>
            <Form.Item
              name="uker"
              className="w-1/2 m-0"
              rules={[
        ...
        >
          {
            ({ getFieldsValue, getFieldsError }) => {
              ...
              if (tipe_audit === "REG") canGoNext = canGoNext && uker.orgeh && uker.branch && !anyErrors
              else if (tipe_audit === "TMT") canGoNext = canGoNext && tema
              return (
