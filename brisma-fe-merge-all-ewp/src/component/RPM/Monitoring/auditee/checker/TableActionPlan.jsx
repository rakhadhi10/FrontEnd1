...
import { approveActionPlanChecker, rejectActionPlanChecker } from "../../../../../store/ducks/RPMAuditee/actions";
...
const TableActionPlan = ({
  ...
  const disabled = status_kode !== STATUS.PENDING_CHECKER_AUDITEE
...
const CheckerActions = ({ statusDisabled, approve, reject }) => {
