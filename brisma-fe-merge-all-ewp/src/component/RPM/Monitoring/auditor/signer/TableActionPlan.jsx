...
import { approveActionPlanSigner, rejectActionPlanSigner } from "../../../../../store/ducks/RPMAuditor/actions";
...
const TableActionPlan = ({
  ...
  const disabled = status_kode !== STATUS.PENDING_SIGNER_AUDITOR
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      />
      <SignerActions
        statusDisabled={disabled || alreadySigned}
...
const SignerActions = ({ evaluasi, statusDisabled, approve, reject }) => {
...
const mapStateToProps = (state, ownProps) => ({
  alreadySigned: ownProps.signed_by.includes(String(getUserPN(state)))
})
