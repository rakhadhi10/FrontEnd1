...
import { getTargetAuditAikpTable } from "./target_audit_aikp";
import { getTimAuditTable } from "./tim_audit";
import { getHtml } from "./html";

export const generateHtmlAikp = ({
  tahun,
  latar_belakang,
  sumber_informasi,
  target_audit_data,
  ...
  const target_audit_aikp_table = getTargetAuditAikpTable(target_audit_data);
  const jadwal_audit_aikp_table = getJadwalAuditTable(jadwal_audit_data);

  const html = getHtml(
    latar_belakang,
    sumber_informasi,
    target_audit_aikp_table,
    jadwal_audit_aikp_table,
    sbp_table,
    jadwal_lain_table,
    tim_audit_table,
    biaya_total,
