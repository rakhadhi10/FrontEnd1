            ...
            <td style="padding: 10px;">
                ${
                  c.sesudah
                    ...
                    <p>
                        Nama Tim Audit: ${c.sesudah.tim_audit_id}
                    </p>
                    <p>
                        Total Anggaran: Rp. ${numberWithCommas(
...
export const getAddendumAITITable = (data) => addendum_table(prepareData(data));
