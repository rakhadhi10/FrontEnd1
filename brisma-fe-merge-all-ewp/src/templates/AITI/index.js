...
import { getTargetAuditAitiTable } from "./target_audit_aiti";
import { getTimAuditTable } from "./tim_audit";
import { getHtml } from "./html";

export const generateHtmlAiti = ({
  tahun,
  latar_belakang,
  sumber_informasi,
  target_audit_data,
  ...
  const target_audit_aiti_table = getTargetAuditAitiTable(target_audit_data);
  const jadwal_audit_aiti_table = getJadwalAuditTable(jadwal_audit_data);

  const html = getHtml(
    latar_belakang,
    sumber_informasi,
    target_audit_aiti_table,
    jadwal_audit_aiti_table,
    sbp_table,
    jadwal_lain_table,
    tim_audit_table,
    biaya_total,
