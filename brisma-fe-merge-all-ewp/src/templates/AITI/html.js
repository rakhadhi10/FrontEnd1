      ...
      <div class="header">
        ...
        <div style="margin-top: 10px;">
          <div style="display: grid; grid-template-columns: 75px 1fr">
            ...
            <h4 style="justify-self: left">: Test alamat</h4>
          </div>
          <div style="display: grid; grid-template-columns: 75px 1fr">
            <h4 style="justify-self: left">Fax</h4>
            <h4 style="justify-self: left">: Test Fax</h4>
          </div>
          <div style="display: grid; grid-template-columns: 75px 1fr">
            <h4 style="justify-self: left">No. Tlp</h4>
            <h4 style="justify-self: left">: Test no tlp</h4>
          </div>
        </div>
      </div>
    </header>
    ...
    >
      ...
      <div style="margin-top: 0.5rem;">
        <div style="width: 250px; display: grid; grid-template-columns: 125px 1fr;">
          ...
          <P style="justify-self: left;">Kanca Test...</P>
        </div>
        <div style="width: 250px; display: grid; grid-template-columns: 125px 1fr;">
