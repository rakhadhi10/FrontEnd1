...
import CardActionPlanMakerAuditee from "../../../../../../component/RPM/Monitoring/auditee/maker/CardActionPlan";
  ...
  return (
    <AppLayout title="RPM" breadcrumb={RPMAuditeeBreadcrumb}>
      ...
      <div className="flex justify-between items-center">
        ...
        <Button
          type="primary"
          // disabled={surat.status_kode_surat !== STATUS.SURAT_PENDING_MAKER_AUDITEE}
      ...
      <div className="py-8">
        <CollapseRekomendasi {...props} card={CardActionPlanMakerAuditee} />
      </div>
    </AppLayout>
  );
}
