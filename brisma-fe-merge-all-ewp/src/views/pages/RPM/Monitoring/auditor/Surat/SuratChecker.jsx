...
import { approveSuratChecker, rejectSuratChecker } from "../../../../../../store/ducks/RPMAuditor/actions";
import STATUS from "../../../../../../utils/rpmStatus";

function SuratChecker({ surat, approve, reject, fetchSuratDetails }) {
  const { id, kkpt_id } = useParams()

  const disabled = surat.status_kode_surat !== STATUS.SURAT_PENDING_CHECKER_AUDITOR_EVALUASI
