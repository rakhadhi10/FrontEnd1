export const patAIWJadwalAuditState = state => state.pat_aiw_jadwal_audit;
...
export const getCreateModal = (state) => patAIWJadwalAuditState(state).modal.create;
...
export const getFormLoading = (state) => patAIWJadwalAuditState(state).formLoading;

export const getCurrentStep = (state) => patAIWJadwalAuditState(state).currentStep;
export const getCurrentEditedId = (state) => patAIWJadwalAuditState(state).currentEditedId;

export const getFormStepOne = (state) => patAIWJadwalAuditState(state).step["0"].form;
export const getFormStepTwo = (state) => patAIWJadwalAuditState(state).step["1"].form;
export const getFormStepThree = (state) => patAIWJadwalAuditState(state).step["2"];
...
export const getSpecialTematikRows = (state) => getFormStepTwo(state).specialTematikRows;
export const getEchannels = (state) => getFormStepTwo(state).echannels;

export const getRegulerModal = (state) => patAIWJadwalAuditState(state).step["1"].modal.reguler;
export const getSpesialTematikModal = (state) => patAIWJadwalAuditState(state).step["1"].modal.spesialTematik;
