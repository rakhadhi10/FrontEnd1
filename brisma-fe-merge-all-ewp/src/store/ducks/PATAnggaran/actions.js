...
export const fetchAnggaran = (pat_id) => async (dispatch, getState, api) => {
  ...
  const { error, data, page } = await api.getAllKegiatan(
    getToken(getState()),
    pat_id,
...
export const submitForm = (pat_id) => async (dispatch, getState, api) => {
  ...
  const { error } = await api.createKegiatanLain(
    getToken(getState()),
    finalForm,
  );
  if (!error) {
...
export const submitEditForm = (pat_id) => async (dispatch, getState, api) => {
  ...
  const { error } = await api.updateKegiatanLain(
    getToken(getState()),
    finalForm,
  );
  if (!error) {
...
export const deleteKegiatanLain =
  (pat_id, kegiatan_id) => async (dispatch, getState, api) => {
    ...
    const { error } = await api.deleteKegiatanLain(
      getToken(getState()),
      pat_id,
      kegiatan_id,
    );
...
export const openEditModal =
  (pat_id, kegiatan_id) => async (dispatch, getState, api) => {
    const { error, data } = await api.getDetailKegiatan(
      getToken(getState()),
      pat_id,
      kegiatan_id,
    );
