export const patAnggaranState = (state) => state.addendum_pat_anggaran;
...
export const getDeleteLoading = (state) =>
  patAnggaranState(state).deleteLoading;
...
export const getEditFormError = (state) =>
  patAnggaranState(state).editFormError;
export const getEditFormLoading = (state) =>
  patAnggaranState(state).editFormLoading;
