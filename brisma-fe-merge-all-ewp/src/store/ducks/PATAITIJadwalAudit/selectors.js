export const patAITIJadwalAuditState = state => state.pat_aiti_jadwal_audit;
...
export const getCreateModal = (state) => patAITIJadwalAuditState(state).modal.create;
export const getEditModal = (state) => patAITIJadwalAuditState(state).modal.edit;

export const getCurrentStep = (state) => patAITIJadwalAuditState(state).currentStep;
export const getCurrentEditedId = (state) => patAITIJadwalAuditState(state).currentEditedId;

export const getFormError = (state) => patAITIJadwalAuditState(state).formError;
export const getFormLoading = (state) => patAITIJadwalAuditState(state).formLoading;
export const getFormStepOne = (state) => patAITIJadwalAuditState(state).step["0"].form;
export const getFormStepTwo = (state) => patAITIJadwalAuditState(state).step["1"].form;
export const getFormStepThree = (state) => patAITIJadwalAuditState(state).step["2"];
