export const patTimAuditState = (state) => state.addendum_pat_tim_audit;
...
export const getDeleteLoading = (state) =>
  patTimAuditState(state).deleteLoading;
...
export const getEditFormError = (state) =>
  patTimAuditState(state).editFormError;
export const getEditFormLoading = (state) =>
  patTimAuditState(state).editFormLoading;
...
export const getCurrentEditedTeamId = (state) =>
  getEditState(state).currentTeamId;
export const getCurrentEditedTeam = (state) => getEditState(state).team;
export const getEditTeamFetchLoading = (state) =>
  getEditState(state).fetchLoading;
