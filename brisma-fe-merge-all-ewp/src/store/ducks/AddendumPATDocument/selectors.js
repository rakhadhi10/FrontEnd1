export const patDocumentState = (state) => state.addendum_pat_document;
...
export const getPersetujuanCode = (state) =>
  getInfoState(state).stc_persetujuan_kode;
...
export const getRefBabPatKode = (state) =>
  patDocumentState(state).ref_bab_pat_kode;
export const getDocContent = (state) =>
  patDocumentState(state).document_content;
